...
from forgery_detection.examples.copy_move_detection import container
from forgery_detection.examples.copy_move_detection import block
    ...
    def reconstruct(self):
        ...
        for key in sorted_offset:
            ...
            if is_pair_found == False:
                ...
                f = open('media/result.txt','w')
                f.write('Found pair(s) of Possible Fraud Attack')
                f.close()
                is_pair_found = True
        ...
        if is_pair_found == False:
            ...
            f = open('media/result.txt','w')
            f.write('No Pair of Possible Fraud Attack Found')
            f.close()
        ...
        ##############################################################################
        imageio.imwrite("media/output_images/output1/" + self.image_name, groundtruth_image)
        imageio.imwrite("media/output_images/output2/" + self.image_name, lined_image)

        return "media/output_images/output1/" + self.image_name